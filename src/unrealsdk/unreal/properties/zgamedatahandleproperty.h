...
#define UNREALSDK_ZGAMEDATAHANDLEPROPERTY_FIELDS(X) \
    X(int32_t, HandleTypeId)                        \
    X(UObject*, HandleTypeObject)
...
template <>
struct PropTraits<ZGameDataHandleProperty>
    : public AbstractPropTraits<ZGameDataHandleProperty> {
